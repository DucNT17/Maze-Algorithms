...
public class Cell{
	...
	Cell(int row,int col,int cellSize){
		...
		parent = null;
		fontWeight = (int)(10+0.3*(cellSize-20)); //cai nay de khi cellsize to thi font to theo
		strokeSize = (int)((5.0/9 * ((cellSize/10)-1) )+1); // cai nay de khi cellsize to thi stroke to theo
	}
